  ...
  (
    ...
    const handleSalvarEdicao = async () => {
      ...
      try {
        ...
        const contatosFormatados = dadosEditaveis.contatos
          ...
          .map((contato) => {
            ...
            if (["Instagram", "Facebook", "LinkedIn"].includes(contato.tipo)) {
              valorFormatado = formatarUsernameParaURL(
                contato.tipo,
                contato.valor
              );
            }
        ...
        setMensagem(
          erro.message || "Erro ao atualizar perfil. Tente novamente."
        );
        return false;
      } finally {
        setCarregando(false);
    ...
    if (modoEdicao) {
      return (
        <div className="containerPrincipal margemInferiorGrande">
          <div className="alinharCentro">
            <div className="containerFoto posicaoRelativa">
              <img
                ...
                src={
                  previewFoto || dadosPerfil.foto || "/placeholder-avatar.jpg"
                }
                alt={`Preview da foto de ${dadosEditaveis.nome}`}
              />
              <div
                className="sobreposicaoFoto opaco"
            ...
            <div className="campoFormulario margemSuperiorPequena">
              <label htmlFor="urlFoto" className="rotuloCampo">
          ...
          <div
            className={`cartaoDestaque fundoMarromDestaqueTransparente textoEsquerda margemInferiorPequena ${
          ...
          <div className="cartaoDestaque fundoMarromDestaqueTransparente textoEsquerda">
            ...
            <p className="texto-obrigatorio">
              Para redes sociais, digite apenas o username (ex: "rhuam7282" para
              Instagram)
            </p>
            ...
            <div className="contatos-empilhados">
              {dadosEditaveis.contatos.map((contato, index) => (
                <div key={index} className="item-contato">
                    ...
                    <input
                      ...
                      placeholder={
                        contato.tipo === "Telefone"
                          ...
                          ? "nomeusuario"
                          : contato.tipo === "Facebook"
                          ? "nomeusuario"
                          : contato.tipo === "LinkedIn"
                          ? "nomeusuario"
                          : "Valor do contato"
                      }
                      className={
                  ...
                  {["Instagram", "Facebook", "LinkedIn"].includes(
                    contato.tipo
                  ) &&
                    contato.valor && (
      ...
      <div className="containerPrincipal margemInferiorGrande">
        <div className="flexCentro alinharCentro flexColuna">
          <div className="containerFoto posicaoRelativa">
            ...
            />
            {isPerfilProprio && ( // ✅ Usar a prop recebida, não a variável local
              <div
                className="sobreposicaoFoto"
